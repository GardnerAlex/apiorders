import {ApiRequest, PlaceOrderInterface, RestOrderInterface} from '../restInterfaces';
import { ApiOrdersDbInterface } from '../../db/dbInterfaces';
...
const dbService: ApiOrdersDbInterface = require('../../db/dbConnectors/restOrders/restOrdersDbConnector');
